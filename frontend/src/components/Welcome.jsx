...
const Welcome = () => {
  ...
  const handleSumbit = (e) => {
    ...
    if (!addressTo || !amount || !keyword || !message) {
      return alert("Please enter appropriate values");
    }
      ...
      <div className="flex mf:flex-row flex-col items-center justify-between md:p-20 py-12 px-4">
        <div className="flex flex-1 justify-start flex-col mf:mr-10">
          ...
          <p className="text-left mt-5 text-white font-light md:w-9/12 w-11/12 text-base">
            Explore the crypto world. Buy and sell crypto easily on Crypt.
          </p>
        ...
        <div className="flex flex-col flex-1 items-center justify-start w-full mf:mt-0 mt-10">
          <div className="p-3 justify-end items-start flex-col rounded-xl h-52 sm:w-96 w-full my-5 eth-card white-glassmorphism">
